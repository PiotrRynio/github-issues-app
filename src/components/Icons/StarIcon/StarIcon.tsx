...
import { Theme } from 'assets/styles/themes/types';

export const StarIcon = ({ typographyVariant, ariaLabel, fill = 'currentColor' }: IconProps) => {
  const { typographies } = useTheme() as Theme;

  const size = typographies[typographyVariant].lineHeight;

  return (
    <svg width={size} height={size} fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby={ariaLabel}>
